            ...
            <?php foreach($herramientas as $herramienta): ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="formulario.php?id=<?= $herramienta['id']; ?>" type="button" class="btn btn-dark"><i class="bi bi-pencil"></i></a>
                  <?php endif; ?>
                  <a href="movimientos.php?id=<?= $herramienta['id']; ?>" type="button" class="btn btn-light"><i class="bi bi-rocket-takeoff"></i></a>
                  <?php if (isset($_SESSION["rol"]) && $_SESSION["rol"] === "administrador"): ?>
                  <a href="crud/eliminar.php?id=<?= $herramienta['id']; ?>" type="button" class="btn btn-danger"><i class="bi bi-trash3"></i></a>
                  <?php endif; ?>
                </td>
              </tr>
            <?php endforeach; ?>
